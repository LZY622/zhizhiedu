	...
	<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
        <div class="widget am-cf">
            ...
            <div class="widget-body  am-fr">
                ...
                <form action="/teacher/stu_wcorrect/create" method="get">
					<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
		...
		<div class="modal-dialog modal-lg" role="document">
    		<div class="modal-content">
				...
				<div class="widget-body am-fr">
					...
					<br>
					<hr>
					<form action="/teacher/stu_wcorrect/upload_update" method="post" enctype="multipart/form-data" id="file">
						{{ csrf_field() }}
...
<script>
    ...
    $('.am-fr ul').addClass("am-pagination tpl-pagination");
   	...
   	$('button[data-target=".bs-modal"]').click(function(){
    	...
    	$('#stu_upd_num').attr('action','/teacher/stu_wcorrect/'+cid_s);
    	$.ajax({
		    type:'GET',
		    url:'/teacher/stu_wcorrect/'+cid_s,
		    dataType:'json',
   	...
   	$('button[data-target=".bs-modal-lg"]').click(function(){
   		...
   		$.ajax({
		    type:'GET',
		    url:'/teacher/stu_wcorrect/'+$(this).attr('cid')+'/edit',
		    dataType:'json',
		    data:{},
		    success:function(data){
		    	if (data.status == 1) {
   	...
   	$('input[name=word_files]').change(function(){
   		...
   		$.ajax({
		    ...
		    type:'POST',
		    url:'/teacher/stu_wcorrect?name=word_files',
		    dataType:'json',
		    cache: false,
		    data:formData,
		    contentType: false,
   	...
   	$('input[name=pdf_files]').change(function(){
   		...
   		$.ajax({
		    ...
		    type:'POST',
		    url:'/teacher/stu_wcorrect?name=pdf_files',
		    dataType:'json',
		    cache: false,
		    data:formData,
		    contentType: false,
   	...
   	$('button[data-target=".bs-lg"]').click(function(){
    	...
    	$('#shenhe_upd_num').attr('action','/teacher/stu_wcorrect/shenhe/'+cid);
   	});
</script>
