...
<div class="tpl-login">
    <div class="tpl-login-content">
        ...
        <span class="tpl-login-content-info">
          我已经有账号请>>><a href="/teacher/login"> 登录</a>
        </span>
        @if(session('success'))  
        ...
        <form class="am-form tpl-form-line-form" action="/teacher/signup" method="post">
            {{csrf_field()}}
            ...
            <div class="am-form-group">
                ...
                <img src="/teacher/code" alt="" style="display: inline;" onclick="this.src=this.src+='?1'">
            </div>
