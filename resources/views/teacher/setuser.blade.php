...
<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
    <div class="widget am-cf">
        ...
        <div class="widget-body am-fr">
            <form class="am-form tpl-form-border-form tpl-form-border-br" action="/teacher/setuser" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                ...
                <div class="am-form-group">
                    <label for="user-name" class="am-u-sm-3 am-form-label">QQ号 <span class="tpl-form-line-small-title">QQ</span></label>
                    <div class="am-u-sm-9">
                        <input class="tpl-form-input" name="qq" value="{{$rs->qq}}" type="text">
                        <small>请填写正确的qq</small>
                    </div>
                </div>
                <div class="am-form-group">
