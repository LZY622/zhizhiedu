			...
			<div class="we-work-bottom">
				 <div class="col-md-6 we-work-left">
				 	<div class="col-md-6 we-left-img1">
				 		<img src="/student/images/w1.jpg" alt="" class="img-responsive">
				 	</div>
				 	<div class="col-md-6 we-left-img2">
				 		<img src="/student/images/w2.jpg" alt="" class="img-responsive">
				 	</div>
				 	<div class="clearfix"> </div>
				 </div>
		...
		<div class="features-main">
			  ...
			  <div class="features-bottom">
			  	 <div class="col-md-3 feature-grid">
			  	 	<img src="/student/images/f1.jpg" alt="" class="img-responsive">
			  	 	<h4>voluptatem accusantium</h4>
			  	 	<p>quae ab illo inventore veritatis et quasi architecto beatae vitae</p>
			  	 </div>
			  	  <div class="col-md-3 feature-grid">
			  	 	<img src="/student/images/f2.jpg" alt="" class="img-responsive">
			  	 	<h4>voluptatem accusantium</h4>
			  	 	<p>quae ab illo inventore veritatis et quasi architecto beatae vitae</p>
			  	 </div>
			  	  <div class="col-md-3 feature-grid">
			  	 	<img src="/student/images/f3.jpg" alt="" class="img-responsive">
			  	 	<h4>voluptatem accusantium</h4>
			  	 	<p>quae ab illo inventore veritatis et quasi architecto beatae vitae</p>
			  	 </div>
			  	  <div class="col-md-3 feature-grid">
			  	 	<img src="/student/images/f4.jpg" alt="" class="img-responsive">
			  	 	<h4>voluptatem accusantium</h4>
			  	 	<p>quae ab illo inventore veritatis et quasi architecto beatae vitae</p>
			  	 </div>
			  	 <div class="clearfix"> </div>
